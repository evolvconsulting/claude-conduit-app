...
const GOTCHAS = [
  ...
  'A background pm2 process can outlive quitting (and even uninstalling) this app — same shared, persistent daemon model as the reboot-persistence note above. Updating past it works fine on Windows/Linux; a fresh uninstall still completes and deregisters cleanly, but the daemon\'s own locked copy of the runtime is left behind under `~/.pm2/daemon-interpreter/`, with no in-app way to remove it.',
];

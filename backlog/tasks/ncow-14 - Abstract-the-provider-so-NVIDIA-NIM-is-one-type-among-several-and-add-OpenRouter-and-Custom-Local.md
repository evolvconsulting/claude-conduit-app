...
Expect this to want splitting into subtasks when it is picked up. It also interacts with NCOW-8 (model alias rename), NCOW-12 (rebrand, which drops the NVIDIA-specific product framing) and NCOW-15, which builds multiple saved connections on top of this abstraction.

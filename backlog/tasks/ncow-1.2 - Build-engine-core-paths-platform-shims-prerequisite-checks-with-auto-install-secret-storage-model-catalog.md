...
- pm2 itself is intentionally absent from prereqs.js/runAllPrereqChecks — per the plan it is a bundled dependency driven programmatically (NCOW-1.3s job), never a detected/missing prerequisite.

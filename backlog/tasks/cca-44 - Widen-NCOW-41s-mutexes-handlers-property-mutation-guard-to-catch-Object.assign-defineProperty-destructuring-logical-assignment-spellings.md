...
id: CCA-44
title: >-
  Widen CCA-41's mutexes/handlers property-mutation guard to catch
...
5. Add a second test that splices each of the 4 new spellings onto a real copy of index.js's
   ...
   reproduction of CCA-41's original (unwidened) detector misses every one.
...
assertions). Non-vacuity self-check: swapped identifierPropertyIsAssigned() back to CCA-41's
...
comment is now stale again (383) -- same class of drift CCA-42's sibling doc-fix (PR #35)
previously corrected.

Branch fix/CCA-44-widen-mutation-guard-spellings pushed to origin. Two commits: widened
...
judgment call confirmed as the right superset, consistent with CCA-41's own canonical
...
test count is stale again -- deferred to the wave-integration doc pass, same as CCA-32's
review found independently.

Overlap risk: none. Disjoint file set from CCA-32 (which touches src/main/ipc.js,

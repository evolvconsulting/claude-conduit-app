...
REGRESSION CHECK: npm test 101/101 throughout, and a third consecutive clean full end-to-end run of the app from source (50/50 assertions, 0 failures) after the tray refactor from NCOW-1.8.
<!-- SECTION:NOTES:END -->

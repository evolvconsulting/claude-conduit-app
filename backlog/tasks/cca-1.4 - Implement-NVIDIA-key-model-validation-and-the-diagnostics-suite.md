...
<!-- SECTION:PLAN:BEGIN -->
1. Investigate the HTTP 500 vs 401 discrepancy from CCA-1.3 by starting a real proxy and sending DESIGN.md section 11 Request A shaped correctly, with and without auth, to determine actual litellm behavior.

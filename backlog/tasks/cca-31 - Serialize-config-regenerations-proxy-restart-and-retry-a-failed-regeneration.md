...
Found independently by both CCA-30's opus reviewers (2026-08-04), across
its two review passes.

CCA-30 added a launch-time stale-config regeneration mechanism
...
deliberately deferred out of CCA-30's own fix pass as out of scope for a
single-task fix:
...
2. **A failed restart is never retried.** regenerateStaleConfig() stamps
   ...
   again. Compounding this, the current failure-logging (added in CCA-30's

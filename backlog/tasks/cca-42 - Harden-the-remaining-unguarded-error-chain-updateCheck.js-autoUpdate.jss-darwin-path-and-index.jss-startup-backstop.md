...
- [x] #4 A regression test demonstrates the full chain end-to-end: a hostile/malformed error surfacing from updateCheck.js's fetch layer does not produce an unhandled rejection anywhere in this chain, mirroring CCA-40's own adversarial test rigor
- [x] #5 npm test passes
<!-- AC:END -->
...
7. Run npm test, confirm before/after counts, commit in small logical commits with
   Refs CCA-42. trailers, push.
<!-- SECTION:PLAN:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
Implemented on fix/CCA-42-error-chain-hardening, pushed to origin. Hardened all 3 sites
...
-> checkForUpdates() -- exactly the chain CCA-42 describes. index.js's site (untestable via
...
Three commits on the branch, each with a Refs CCA-42. trailer.

...
10. Commit in two logical commits mirroring CCA-45's precedent (fix, then tests) and push.
<!-- SECTION:PLAN:END -->

## Implementation Notes

<!-- SECTION:NOTES:BEGIN -->
**Worker implementation evidence (wave 7, sonnet, worktree slot 1, branch fix/CCA-46-harden-multi-lock-resolution @ base cd32488) — pre-review, not yet independently confirmed:**
...
- AC#6: baseline 400/400 before any change; final npm test '# tests 410 / # pass 410 / # fail 0' — the +10 are exactly the new CCA-46 tests.

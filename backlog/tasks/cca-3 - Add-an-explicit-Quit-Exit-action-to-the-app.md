...
2. Introduce a single requestQuit() path in src/main/index.js and route the tray, the menus and a new IPC call through it, so CCA-4 has exactly one place to hook proxy shutdown into.
